...
class TripRequest(models.Model, BaseModelInterface):
    ...
    location_a = models.ForeignKey(UserLocation, on_delete=models.PROTECT, related_name="location_a")
    location_b = models.ForeignKey(UserLocation, on_delete=models.PROTECT, related_name="location_b")
